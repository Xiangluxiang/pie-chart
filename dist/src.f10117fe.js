...
},{"../dist/chart.js":"node_modules/chart.js/dist/chart.js"}],"src/index.ts":[function(require,module,exports) {
"use strict";
...
var myPieChart = new auto_1.default(ctx, {
  type: 'pie',
  data: data,
  options: {}
});
...
function updateOrAddChartData(label, value, existingColor) {
  var _a, _b;
  var labelIndex = (_a = myPieChart.data.labels) === null || _a === void 0 ? void 0 : _a.indexOf(label);
  var color = existingColor || isValidColor(label) ? label : generateRandomColor();
  if (labelIndex !== undefined && labelIndex > -1) {
    ...
    (_b = myPieChart.data.labels) === null || _b === void 0 ? void 0 : _b.push(label);
...
function updateDataTable() {
  ...
  (_a = myPieChart.data.labels) === null || _a === void 0 ? void 0 : _a.forEach(function (label, index) {
    var row = dataTableBody.insertRow();
    var labelCell = row.insertCell(0);
    var dataCell = row.insertCell(1);
    var actionsCell = row.insertCell(2);
    labelCell.innerHTML = "<input type=\"text\" value=\"".concat(label, "\" readonly />");
    dataCell.innerHTML = "<input type=\"number\" value=\"".concat(myPieChart.data.datasets[0].data[index], "\" readonly />");
    ...
    editButton.onclick = function () {
      var isReadOnly = labelCell.getElementsByTagName('input')[0].readOnly;
      ...
      if (!isReadOnly) {
        ...
        var newLabel = labelCell.getElementsByTagName('input')[0].value;
        var newValue = parseFloat(dataCell.getElementsByTagName('input')[0].value);
...
addDataBtn.addEventListener('click', function () {
  ...
  var value = parseFloat(dataInput.value);
